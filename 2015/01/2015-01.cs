...
namespace _01
{
    class Program
    {
        ...
        {
            string filePath;
            // filePath = @".\testInput1.txt";
            // filePath = @".\testInput5.txt";
            filePath = @".\Input.txt";
            ...
            for(int i = 0; i < text.Length; i++)
            {
                ...
                if( (!basementFound) && (-1 == finalFloor) )
                {
                    basementChar = i+1;
                    basementFound = true;
                }
            }
            Console.WriteLine("Final floor: {0}", finalFloor);

            Console.WriteLine("Santa entered the basement at character {0}", basementChar);
        }
    }
}
